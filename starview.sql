...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 11, 2016 at 12:48 PM
...
(4, '51 Nguyễn Thái Học, Văn Miếu, Đống Đa, Hà Nội, Việt Nam', '51 Nguyen Thai Hoc, Van Mieu, Dong Da, Ha Noi, Viet Nam', '21.028946091', '105.840650746', '51 Nguyễn Thái Học', '', '51 Nguyen Thai Hoc', 'Đống Đa', 'Dong Da', 'Hà Nội', 'Ha Noi', '100000', 'Việt Nam', 'Viet Nam'),
(5, '27 Trần Duy Hưng, Hà Nội, Việt Nam', '27 Tran Duy Hung, Ha Noi, Viet Nam', '21.013457400', '105.803312200', '27 Trần Duy Hưng', '10 LE THANH NGHI, HA BA TRUNG', '27 Tran Duy Hung, Hai Ba Trung', 'Thanh Xuân', 'Thanh Xuan', 'Hà Nội', 'Ha Noi', '10000', 'Việt Nam', 'Viet Nam'),
(6, 'Đường dạo bộ rừng thông, Ngọc Thanh, tx. Phúc Yên, Vĩnh Phúc, Vietnam', '', '21.332064924', '105.718810916', 'Đường dạo bộ rừng thông', 'Thôn ??ng Dè,', NULL, 'phuc yen', 'phuc yen', 'Vĩnh Phúc', 'Vinh Phuc', '10000', 'Vietnam', 'Vietnam');
...
(3, 'Thông báo đặt phòng gửi đến người quản trị', '<p>Bạn đ&atilde; đặt ph&ograve;ng th&agrave;nh c&ocirc;ng</p>', 1),
(4, 'Thông báo đặt phòng gửi đến đối tác', '', 2),
(5, 'Thông báo đặt phòng đến người đặt phòng', '', 3),
...
(1, 1, 14, 3500000, '2016-07-11', '2016-07-14', 5),
(2, 1, 14, 3500000, '2016-07-19', '2016-07-22', 5),
(3, 1, 14, 1500000, '2016-07-18', '2016-07-18', 1);
...
INSERT INTO `tbl_permissions` (`module_id`, `user_id`) VALUES
('Amenities', 2),
('Config', 2),
('emails', 2),
('Experience', 2),
...
(6, 6, 'Flamingo Đại Lải ResortFlamingo Đại Lải ResortFlam', '', NULL, 0, 'Flamingo Đại Lải Resort tại Ngọc Thanh - Phúc Yên - Vĩnh Phúc trải dài trên 123 héc ta phía Bắc hồ Đại Lải, được bao quanh bởi 500 héc ta mặt nước và hàng ngàn héc ta rừng thông. Cách trung tâm Hà Nội khoảng 50 km, cách sân bay quốc tế Nội Bài khoảng 25 km.\r\n\r\nĐón đầu xu hướng hình thành những điểm nghỉ dưỡng vùng núi – hồ, tổ hợp nghỉ dưỡng sinh thái cao cấp Flamingo Đại Lải Resort do Công ty Cổ phần Hồng Hạc Đại Lải làm chủ đầu tư với số vốn đầu tư lên đến 2.000 tỷ đồng đã và đang được xây dựng để trở thành một trong những điểm đến hấp dẫn của Vĩnh Phúc. DTJ vinh dự là một trong các nhà phân phối dự án này.', 12, 5, 1, 1, 1, NULL, 1, 70, '39,20,10,9,8,4,3,2,1', NULL, '7000000', '350', '7200000', '351', '8', '7000000', '350', '680000', '348', '0', '0', '300000', '150', '0', '0', NULL, '', '', NULL, '["\\/uploads\\/room\\/03m1459595972_flamingo_dai_lai_resort.jpg","\\/uploads\\/room\\/6es1459596003_flamingo_dai_lai_resort.jpg","\\/uploads\\/room\\/8nn1459595971_flamingo_dai_lai_resort.jpg","\\/uploads\\/room\\/bra1459596003_flamingo_dai_lai_resort.jpg","\\/uploads\\/room\\/bto1459596000_flamingo_dai_lai_resort.jpg","\\/uploads\\/room\\/dp31459596001_flamingo_dai_lai_resort.jpg","\\/uploads\\/room\\/eoq1459595969_flamingo_dai_lai_resort.jpg","\\/uploads\\/room\\/l601459595970_flamingo_dai_lai_resort.jpg","\\/uploads\\/room\\/lgu1386304916_flamingo-dai-lai-resort.jpg","\\/uploads\\/room\\/me11459595973_flamingo_dai_lai_resort.jpg","\\/uploads\\/room\\/wdu1459595972_flamingo_dai_lai_resort.jpg","\\/uploads\\/room\\/wtq1459595975_flamingo_dai_lai_resort.jpg","\\/uploads\\/room\\/wyi1459595974_flamingo_dai_lai_resort.jpg","\\/uploads\\/room\\/xt41459595976_flamingo_dai_lai_resort.jpg","\\/uploads\\/room\\/ypg1459595976_flamingo_dai_lai_resort.jpg","\\/uploads\\/room\\/z6u1459596000_flamingo_dai_lai_resort.jpg","\\/uploads\\/room\\/zp51459596002_flamingo_dai_lai_resort.jpg"]', '2016-07-11 00:00:00', '2016-07-11 00:00:00', 1);
...
--
ALTER TABLE `tbl_post_room`
  MODIFY `post_room_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `tbl_permissions`
  ADD CONSTRAINT `fk_permissions_user` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`);
...
ALTER TABLE `tbl_permissions_actions`
  ...
  ADD CONSTRAINT `fk_permissions_actions_modules_user` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`),
  ADD CONSTRAINT `fk_permissions_actions_user_1` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`);
