		...
		<fieldset>
			<div class="widget">
				...
				<div class="tab_container tab-content">
				    <div id='tab1' class="tab_content pd0 tab-pane active" role="tabpanel">
				        <div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input type="text" name="house_type_name" id="param_name" _autocheck="true" value="<?php echo $info->house_type_name;?>" />
								</span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input type="text" name="house_type_name_en" id="param_name" _autocheck="true" value="<?php echo $info->house_type_name_en;?>" />
								</span>
								<span name="name_autocheck" class="autocheck"></span>
        		...
        		<div class="formSubmit">
           			...
           			<input type="button" value="Hủy bỏ" class="basic" onclick="if(confirm('Bạn muốn hủy cập nhật và quay lại trang danh sách')){window.location='<?php echo admin_url('amenities');?>';}" />
           		</div>
        		<div class="clear"></div>
			</div>
		</fieldset>
