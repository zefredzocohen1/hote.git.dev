				...
				<div class="tab_container tab-content">
				    <div id='tab1' class="tab_content pd0 tab-pane active" role="tabpanel">
				        <div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input type="text" name="amenities_name" id="param_name" _autocheck="true" value="<?php echo set_value('amenities_name');?>" />
								</span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input type="text" name="amenities_name_en" id="param_name" _autocheck="true" value="<?php echo set_value('amenities_name_en');?>" />
								</span>
								<span name="name_autocheck" class="autocheck"></span>
